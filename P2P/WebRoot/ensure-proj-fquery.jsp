...
<lbt:user-layout title="一级审核">
	...
	function loadData(params){
		$.getJSON("project/ensureProjFquery", function(resp){
			var projs = resp['list'];
			...
			for (var i in projs)
			{
				...
				tbody.append(
						...
						.append($("<td/>")
									.append($("<a/>").addClass("btXq").attr("target","_blank").attr("href", "ensure-proj-fcheck.jsp?id="+proj.lbtPtpFprojInf.projNo).html("详情"))));
			}
		});
	}
