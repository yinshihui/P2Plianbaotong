...
<lbt:user-layout title="操作员添加">
	<jsp:attribute name="header">
	<%--在这里，header属性中加入页面脚本、样式等位于最终页面<header>标签中的内容 --%>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/operator.css" type="text/css" />
	</jsp:attribute>
	<jsp:body>
		<%-- 具体的内面内容 --%>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>登录用户名：</td>
							<td>
								<input type="text" name="usrName" id="usrName" maxlength=20 class="input"/>
						...
						<tr>
							...
							<td> </td>
							<td>
								<button id="addIssuer" type="button">添加</button>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/operator.js"/></script>
	</jsp:body>
</lbt:user-layout>
