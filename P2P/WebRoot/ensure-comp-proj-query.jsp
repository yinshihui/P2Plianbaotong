...
#closeX:hover{
	...
	function loadData(params){
		$.getJSON("project/queryCompProject", params, function(resp){
			...
			for ( var i in detailList) {
				...
				tbody.append($("<tr/>")
						...
						.append($("<td/>").html($.format.date(new Date(pd.lbtPtpFprojInf.projPutDate), "yyyy-MM-dd HH:mm:ss")))
