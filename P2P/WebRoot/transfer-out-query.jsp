...
<lbt:user-layout title="转出记录查询">
	...
	function loadData(params){
		$.getJSON("invest/transOutQuery", params, function(resp){
			...
			for ( var i in detailList) {
				var pd = detailList[i];
				var type = '交易类型';
				if(pd.lbtPtpTxnDetail.txnType == 't0')
					type = '划入';
				else 
					type = '划出';
				tbody.append($("<tr/>")
						...
						.append($("<td/>").html(checkTxnStatus(pd.lbtPtpTxnDetail.txnStatus)))
     ...
     <div class="box">
        <ul class="boxUL">
          <div class="title1">
            <h4>转出统计</h4>
            <ul>
              	转出<b id= "countTxn"> </b>笔，累计转出金额<b id = "sumAmt"> </b>元
            </ul>
          </div>
